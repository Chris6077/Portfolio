$(function () {
  ...
  -------------------------------------------------------*/
  var typedcount = 1;
  $('.info h3 span')[0].innerHTML = "a GUI/Ux designer";
  setInterval(function(){
    var strings = ["a GUI/Ux designer","a photographer","a devoloper","a graphic Designer", "Christian Winkler"];
    $('.info h3 span')[0].innerHTML = strings[typedcount];
    typedcount++;
    if(typedcount == 5) typedcount = 0;
  }, 3500);
